...
Documentation for this portion is [here](https://docs.picknik.ai/en/stable/getting_started/setup_tutorials/configuring_moveit_studio/configuring_moveit_studio.html).
