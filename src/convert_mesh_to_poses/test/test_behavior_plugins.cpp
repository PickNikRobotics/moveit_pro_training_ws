...
TEST(BehaviorTests, test_load_behavior_plugins)
{
  ...
  {
    auto plugin_instance = class_loader.createUniqueInstance("convert_mesh_to_poses::ConvertMeshToPosesBehaviorsLoader");
  ...
  factory.instantiateTreeNode("test_behavior_name", "ConvertMeshToPoses",
