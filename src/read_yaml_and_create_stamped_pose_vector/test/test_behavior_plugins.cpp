...
TEST(BehaviorTests, test_load_behavior_plugins)
{
  ...
  {
    auto plugin_instance = class_loader.createUniqueInstance("read_yaml_and_create_stamped_pose_vector::ReadYamlAndCreateStampedPoseVectorBehaviorsLoader");
  ...
  factory.instantiateTreeNode("test_behavior_name", "ReadYamlAndCreateStampedPoseVector",
