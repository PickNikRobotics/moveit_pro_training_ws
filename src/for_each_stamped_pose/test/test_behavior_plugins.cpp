...
TEST(BehaviorTests, test_load_behavior_plugins)
{
  ...
  {
    auto plugin_instance = class_loader.createUniqueInstance("for_each_stamped_pose::ForEachStampedPoseBehaviorsLoader");
  ...
  factory.instantiateTreeNode("test_behavior_name", "ForEachStampedPose",
